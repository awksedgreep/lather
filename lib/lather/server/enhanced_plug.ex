defmodule Lather.Server.EnhancedPlug do
  ...
  if Code.ensure_loaded?(Plug) do
    ...
    # Plug not available - provide helpful error message
    def init(_opts) do
      raise """
      Lather.Server.EnhancedPlug requires the :plug dependency.
      Add {:plug, "~> 1.14"} to your deps in mix.exs
      """
    end

    def call(_conn, _opts), do: nil
  end
end
